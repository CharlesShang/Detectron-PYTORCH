...
restore=${train_dir}/maskrcnn_resnet50_coco_ep14.h5

mkdir -p ${train_dir}

python train/train.py --cfg exper/coco/maskrcnn/train_test_resnet50.yaml \
                    --train_dir ${train_dir} \
                    --focal_loss \
                    --max_epoch 15 \
                    --lr ${lr} \
...
python test/test.py --cfg exper/coco/maskrcnn/train_test_resnet50.yaml \
    --train_dir ${train_dir} \
    --restore ${restore} \
    2>&1 | tee ${test_log}
