...
def encode(gt_boxes, rois, num_classes):
  ...
  if gt_boxes.size > 0: 
      ...
      bg_inds = np.where((max_overlaps < cfg.roi_bg_threshold))[0]
      ...
      ignore_inds = np.where(((max_overlaps > cfg.roi_bg_threshold) &\
              (max_overlaps < cfg.fg_threshold)))[0]
      ...
      if _DEBUG: 
          ...
          print ('cfg.roi_bg_threshold:', cfg.roi_bg_threshold)
          # print (max_overlaps)
